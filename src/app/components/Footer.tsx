      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 sm:pt-20 pb-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Contact info */}
            <div className={`space-y-3 text-sm transition-colors duration-500 ${
              theme === 'dark' ? 'text-slate-500' : 'text-gray-600'
            }`}>
          ...
          {Object.entries(footerLinks).map(([title, links], index) => (
            ...
            >
              <h3 className={`font-bold text-base sm:text-lg mb-4 transition-colors duration-500 ${
        ...
        {/* Bottom bar */}
        <div className={`border-t pt-8 flex flex-col md:flex-row items-center justify-between gap-6 transition-colors duration-500 ${
