...
const testimonials = [
  {
    ...
    content:
      "The team delivered an exceptional product that exceeded our expectations. Their attention to detail and commitment to quality is unmatched.",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "Working with this agency was a game-changer for our business. They transformed our vision into a scalable, high-performance platform.",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "Incredible experience from start to finish. The UI/UX design was beautiful and our conversion rates increased by 150%.",
    rating: 5,
    company: "DesignHub",
  },
  {
    ...
    content:
      "Their technical expertise and professionalism are outstanding. They delivered a complex fintech platform on time and within budget.",
    rating: 5,
    company: "FinanceApp",
  },
  {
    ...
    content:
      "The SEO optimization work was phenomenal. We saw a 200% increase in organic traffic within 3 months. Highly recommended!",
    rating: 5,
    company: "GrowthCo",
  },
];
...
export function Testimonials() {
  ...
  return (
    ...
    >
      {/* Fix 2: standard <style> tag instead of styled-jsx <style jsx global> */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          <div
            className={`inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border mb-4 ${
              theme === "dark"
              ...
              <div key={index} className="px-3 sm:px-4">
                ...
                >
                  ...
                  <div className="absolute top-6 right-6 opacity-5">
                    <Quote
                      className={`w-16 h-16 ${theme === "dark" ? "text-indigo-600" : "text-indigo-400"}`}
                    />
                  </div>
                  ...
                  {/* Content */}
                  <p
                    className={`mb-6 leading-relaxed relative z-10 text-sm sm:text-base transition-colors duration-500 ${
                  ...
                  {/* Soft glow */}
                  <div
                    className={`absolute inset-0 rounded-[24px] opacity-0 hover:opacity-100 transition-opacity duration-300 ${
                      theme === "dark"
