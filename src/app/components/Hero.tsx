  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20 md:pt-0">
        ...
        >
          <Sparkles
            className={`w-3 h-3 sm:w-4 sm:h-4 ${theme === "dark" ? "text-indigo-400" : "text-indigo-600"}`}
          />
          <span
            className={`text-xs sm:text-sm font-medium ${theme === "dark" ? "text-indigo-300" : "text-indigo-700"}`}
          >
        ...
        >
          ...
          optimization, and reliable hosting.
        </motion.p>
