...
export function Hero() {
  ...
  return (
    <section className={`relative min-h-screen flex items-center justify-center overflow-hidden transition-colors duration-500 ${
      ...
      <motion.div
        className={`absolute top-20 left-20 w-64 h-64 rounded-[40px] backdrop-blur-xl border ${
          theme === 'dark'
      ...
      />
      <motion.div
        className={`absolute bottom-20 right-20 w-80 h-80 rounded-[60px] backdrop-blur-xl border ${
          theme === 'dark'
      ...
      />
      <motion.div
        className={`absolute top-1/2 left-1/3 w-40 h-40 rounded-[30px] backdrop-blur-xl border ${
          theme === 'dark'
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
        <motion.div
          ...
          className={`inline-flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-xl border mb-8 ${
            theme === 'dark'
        ...
        >
          ...
          <span className={`text-sm font-medium ${theme === 'dark' ? 'text-indigo-300' : 'text-indigo-700'}`}>Premium Digital Solutions</span>
        </motion.div>
        ...
        <motion.h1
          ...
          className={`text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-[1.1] transition-colors duration-500 ${
        ...
        <motion.p
          ...
          className={`text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed transition-colors duration-500 ${
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="group relative px-8 py-4 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-2xl overflow-hidden shadow-lg shadow-indigo-500/30 transition-all duration-300"
          >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className={`px-8 py-4 bg-transparent rounded-2xl border font-semibold shadow-lg backdrop-blur-sm transition-all duration-300 ${
              theme === 'dark'
